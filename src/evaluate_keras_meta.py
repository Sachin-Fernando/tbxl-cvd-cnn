...
# --- Load base models (same as training) ---
...
# --- Load trained meta-classifier (Keras) ---
meta_model_keras = load_model("models/ensemble/meta_classifier_hpo_v2.keras")

# --- Predict and evaluate ---
y_pred_probs = meta_model_keras.predict(X_stack_test)
y_pred = np.argmax(y_pred_probs, axis=1)

acc = accuracy_score(y_test, y_pred)
print(f"✅ Keras Meta-Classifier Accuracy on Unseen Test Data: {acc * 100:.2f}%")
